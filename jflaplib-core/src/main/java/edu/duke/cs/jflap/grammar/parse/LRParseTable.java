 ...
 * ability to function as a <CODE>TableModel</CODE> for a
...
public class LRParseTable extends AbstractTableModel implements Serializable, Cloneable {
     ...
     * @return an improved form of the input, or <CODE>null</CODE> if, for this
     *         location, the value could not be reasonably determined
     */
