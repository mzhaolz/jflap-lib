...
/**
  ...
  public void shiftMode() {
    ...
    cellEditors = new TableCellEditor[table.getRowCount()][table.getColumnCount()];
  ...
  public TableCellRenderer getCellRenderer(int row, int column) {
    ...
    return cellEditors[row][mc] == null ? super.getCellRenderer(row, column) : RENDERER;
  }
  ...
  public TableCellEditor getCellEditor(int row, int column) {
    ...
    int mc = convertColumnIndexToModel(column);
    return cellEditors[row][mc] == null ? super.getCellEditor(row, column) : cellEditors[row][mc];
  }
