...
public class W1VVrW2 extends ContextFreePumpingLemma {
    ...
    public String getHTMLTitle() {
        return "<i>w<sub>1</sub>vv<sup>R</sup>w<sub>2</sub></i>, : "
                ...
                + " 3,  <i>v</i>, <i>w<sub>1</sub>, " + "w<sub>2</sub> " + ELEMENT_OF + " "
                + AB_STAR;
    }
    ...
    public void setDescription() {
        ...
        explanation = "Because this is a context-free language, a valid decomposition exists.  If |'v'| "
                + GREATER_THAN + " 3, " + "or if <i>m</i> " + GREATER_OR_EQ
