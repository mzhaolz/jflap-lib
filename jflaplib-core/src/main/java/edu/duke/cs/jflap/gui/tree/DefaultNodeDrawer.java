...
public class DefaultNodeDrawer implements NodeDrawer {
    ...
    public void draw(Graphics2D g, TreeNode node, boolean dummy) {
        g.fill(new Ellipse2D.Float(-NODE_RADIUS, -NODE_RADIUS, NODE_RADIUS * 4.0f,
                NODE_RADIUS * 2.0f));
        Color c = g.getColor();
        g.setColor(Color.black);
        g.draw(new Ellipse2D.Float(-NODE_RADIUS, -NODE_RADIUS, NODE_RADIUS * 4.0f,
                NODE_RADIUS * 2.0f));
    ...
    public static final Shape NODE_SHAPE = new Ellipse2D.Float(-NODE_RADIUS, -NODE_RADIUS,
