...
public class FSAToRegularExpressionConverter {
     ...
     *         <CODE>expression</CODE> as the transition label.
     */
    public static Transition getTransitionForExpression(int p, int q, String expression,
            Automaton automaton) {
     ...
     */
    public static FSATransition addTransitionOnEmptySet(State fromState, State toState,
            Automaton automaton) {
     ...
     */
    public static FSATransition combineToSingleTransition(State fromState, State toState,
            List<Transition> transitions, Automaton automaton) {
    ...
    public static void convertToSimpleAutomaton(Automaton automaton) {
        ...
        for (int k = 0; k < states.size(); k++) {
            for (int j = 0; j < states.size(); j++) {
                List<Transition> transitions = automaton
                        .getTransitionsFromStateToState(states.get(k), states.get(j));
