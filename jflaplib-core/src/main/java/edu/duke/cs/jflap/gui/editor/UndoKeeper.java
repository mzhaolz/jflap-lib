...
public class UndoKeeper {
  ...
  public void restoreStatus() {
    ...
    else Automaton.become(myMaster, p); //pop off head
  ...
  public void redo() {
    ...
    if (myMaster instanceof TuringMachine)
      TuringMachine.become(
          (TuringMachine) myMaster, (TuringMachine) myBackDeck.pop()); //casting to the high heavens
    else Automaton.become(myMaster, myBackDeck.pop());
