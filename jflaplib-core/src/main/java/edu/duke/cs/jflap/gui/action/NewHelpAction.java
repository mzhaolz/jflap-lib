 ...
 * {@link edu.duke.cs.jflap.gui.action.NewAction}. This class is intended only
 * for the special purpose of being used in the new structure creation window,
 * which is just a list of buttons and does not have the same structure as a
 * document window.
 *
