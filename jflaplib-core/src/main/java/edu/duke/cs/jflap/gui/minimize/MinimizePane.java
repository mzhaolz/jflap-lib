...
public class MinimizePane extends JPanel {
    ...
    public void beginMinimizedAutomaton(FiniteStateAutomaton dfa, DefaultTreeModel tree) {
        ...
        EditorPane ep = new EditorPane(drawer, (ToolBox) (view, drawer1) -> {
            java.util.List<Tool> tools = new LinkedList<>();
        ...
        builderController = new BuilderController(dfa, newAutomaton, drawer, minimizer, tree,
                split);
        ...
        GEMLayoutAlgorithm<State> layout = new GEMLayoutAlgorithm<>();
        Set<State> constantStates = new HashSet<>();
