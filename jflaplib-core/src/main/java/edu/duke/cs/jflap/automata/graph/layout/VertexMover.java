        ...
        if (command == HORIZONTAL_CENTER)
            for (int i = 0; i < vertices.size(); i++) {
                ...
                graph.moveVertex(vertices.get(i),
                        new Point2D.Double(point.getX(), size.getHeight() - point.getY()));
            }
        else if (command == VERTICAL_CENTER)
            for (int i = 0; i < vertices.size(); i++) {
                point = graph.pointForVertex(vertices.get(i));
                graph.moveVertex(vertices.get(i),
                        new Point2D.Double(size.getWidth() - point.getX(), point.getY()));
            }
            ...
            for (int i = 0; i < vertices.size(); i++) {
                point = graph.pointForVertex(vertices.get(i));
                graph.moveVertex(vertices.get(i), new Point2D.Double(size.getWidth() - point.getY(),
                        size.getHeight() - point.getX()));
            }
        // Rotating the graph
