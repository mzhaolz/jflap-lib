...
public class TrapStateTool extends StateTool {
  ...
  public TrapStateTool(
      AutomatonPane view, AutomatonDrawer drawer, AddTrapStateController controller) {
    super(view, drawer);
  ...
  public void mousePressed(MouseEvent event) {
    if ((myTrapState = myController.stateCreate(event.getPoint())) == null) return;
    getView().repaint();
  }
