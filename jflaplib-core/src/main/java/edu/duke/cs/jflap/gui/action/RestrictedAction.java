 ...
 * usual <CODE>Action</CODE> nicities, the <CODE>RestrictedAction</CODE> also
 * provides facilities for determining which types of objects it may be applied
 * to.
 *
...
public abstract class RestrictedAction extends AbstractAction {
	 ...
	 * object based on its class. By default, this method simply returns
	 * <CODE>true</CODE> to indicate that any sort of object is acceptable.
	 *
	 * @param object
	 ...
	 */
	public RestrictedAction(final String string, final Icon icon) {
		super(string, icon);
	}
}
