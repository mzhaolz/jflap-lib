...
/**
 * The <CODE>HelpAction</CODE> is an abstract action that is meant to bring up a
 * help page appropriate to whatever context. It also serves as a general sort
 ...
 * The idea is that an object can store its help page in the
 * <CODE>HelpAction</CODE> via <CODE>setURL</CODE>
 *
...
public abstract class HelpAction extends RestrictedAction {
	...
	private static final WeakHashMap<Object, String> HELP_MAP = new WeakHashMap<>();
	 ...
	 * object available according to <CODE>getURL</CODE>, then the URL indicated
	 * by <CODE>DEFAULT_HELP</CODE> will be displayed in a
	 * <CODE>WebFrame</CODE>.
	 *
	 * @param object
	 ...
	 * @see edu.duke.cs.jflap.gui.WebFrame
	 */
	public static void displayHelp(final Object object) {
	 ...
	 */
	public static String getURL(final Object object) {
		String url = HELP_MAP.get(object);
		if (url != null) {
			return url;
		}
	 ...
	 * @see #getURL(Object)
	 */
	public static void setURL(final Object object, final String url) {
	...
	public HelpAction() {
		super("Help...", null);
		putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_SLASH, MAIN_MENU_MASK));
	}
}
