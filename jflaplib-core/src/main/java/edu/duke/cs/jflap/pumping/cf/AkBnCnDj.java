...
public class AkBnCnDj extends ContextFreePumpingLemma {
    ...
    public String getHTMLTitle() {
        return "<i>a<sup>k</sup>b<sup>n</sup>c<sup>n</sup>d<sup>j</sup></i> : <i>j</i> " + NOT_EQUAL
                + " k";
    }
        ...
        myAllCases.add(new Case() {
            ...
            public boolean isCase(String v, String y) {
                if (v.indexOf("a") > -1 && v.indexOf("b") == -1 && v.indexOf("c") == -1
                        && v.indexOf("d") == -1 && y.indexOf("a") > -1 && y.indexOf("b") == -1
                        && y.indexOf("c") == -1 && y.indexOf("d") == -1) {
                    return true;
                }
                return false;
            }
    ...
    public boolean isInLang(String s) {
        ...
        List<Integer> sections = Lists.newArrayList(0, 0, 0, 0);
