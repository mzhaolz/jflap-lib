 ...
 * <CODE>Configuration</CODE> object is simply a data structure that stores this
 * information, and does not do any work of progressing this configuration to
 * other configurations as a simulator would.
 *
...
public abstract class Configuration implements Cloneable {
     ...
     * @return the <CODE>Configuration</CODE> that led to this configuration, or
     *         <CODE>null</CODE> if this is the initial configuration
     */
     ...
     *
     * @param focus
     *            <CODE>true</CODE> if focused, false if not
     */
    ...
    // /**
    // * Gets the stack of parent automatons (arranged in a hierarchy, top level
    // of the stack
