...
public class SimulateAction extends AutomatonAction {
    ...
    public void handleInteraction(Automaton automaton, AutomatonSimulator simulator,
        ...
        SimulatorPane simpane = new SimulatorPane(automaton, simulator, configs, environment,
                false);
    ...
    protected boolean automatonActionPermissible(Component source) {
        ...
        if (automaton instanceof MealyMachine) {
            ...
            List<State> nd = d.getNondeterministicStates(automaton);
            if (nd.size() > 0) {
                JOptionPane.showMessageDialog(source,
         ...
         */
            ...
            List<State> finalStates = turingMachine.getFinalStates();
