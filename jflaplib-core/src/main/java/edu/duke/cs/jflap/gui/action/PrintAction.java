        ...
        public void print() {
            ...
            if (printJob == null) {
                ...
                if (componentToBePrinted instanceof PrintAction.Bounds) {
                    ...
                    paper.setSize(2.0 * bounds.getX() + bounds.getWidth(),
                            2.0 * bounds.getY() + bounds.getHeight());
                    paper.setImageableArea(bounds.getX(), bounds.getY(), bounds.getWidth(),
                            bounds.getHeight());
