...
public class LayoutAlgorithmFactory {
     ...
     *         value.
     */
    public static <V> LayoutAlgorithm<V> getLayoutAlgorithm(int algorithm, Dimension pSize,
            Dimension vDim, double vBuffer) {
        switch (algorithm) {
            case RANDOM_CHOICE:
            ...
            case VertexMover.NEGATIVE_SLOPE_DIAGONAL:
                return new VertexMover<V>(pSize, vDim, vBuffer,
