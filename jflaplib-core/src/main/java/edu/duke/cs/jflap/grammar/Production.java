...
public class Production implements Serializable {
  ...
  public List<String> getVariables() {
    ...
    List<String> rhsVariables = getVariablesOnRHS();
    ...
    List<String> lhsVariables = getVariablesOnLHS();
  ...
  public List<String> getVariablesOnLHS() {
    List<String> list = new ArrayList<>();
    if (myLHS == null) return Collections.emptyList();
  ...
  public List<String> getTerminals() {
    List<String> list = new ArrayList<>();
    List<String> rhsTerminals = getTerminalsOnRHS();
    ...
    List<String> lhsTerminals = getTerminalsOnLHS();
