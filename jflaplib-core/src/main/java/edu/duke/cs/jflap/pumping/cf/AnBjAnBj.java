...
public class AnBjAnBj extends ContextFreePumpingLemma {
  ...
  public void chooseDecomposition() {
    ...
    if (w.indexOf('a') > -1) setDecomposition(new int[] {0, 1, step, 1});
    else setDecomposition(new int[] {w.indexOf('b'), 1, step, 1});
  }
        ...
        new Case() {
          public boolean isCase(String v, String y) {
            if (v.indexOf("a") > -1
                ...
                && y.indexOf("a") > -1
                && y.indexOf("b") > -1
                && y.indexOf("a") < y.indexOf("b")) return true;
            return false;
          }
  ...
  public boolean isInLang(String s) {
    ...
    if (LemmaMath.isMixture(first, list) || LemmaMath.isMixture(last, list)) return false;
