...
public class TransducerFactory {
    ...
    static {
        ...
        add(null, edu.duke.cs.jflap.gui.pumping.RegPumpingLemmaChooser.class,
                new RegPumpingLemmaTransducer());
        add(null, edu.duke.cs.jflap.gui.pumping.CFPumpingLemmaChooser.class,
                new CFPumpingLemmaTransducer());
    }
