...
public class InvisibleCurvedArrow extends CurvedArrow {
	 ...
	 *            are rather curvy
	 */
	public InvisibleCurvedArrow(final int x1, final int y1, final int x2, final int y2, final float curvy,
			final Transition t) {
	 ...
	 *            are rather curvy
	 */
	public InvisibleCurvedArrow(final Point start, final Point end, final float curvy, final Transition t) {
