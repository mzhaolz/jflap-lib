...
public class UselessProductionRemover {
     ...
     *         <CODE>grammar</CODE> that is not already in <CODE>set</CODE>.
     */
    public static String getVariableThatBelongsInUsefulVariableSet(Grammar grammar,
            Set<String> set) {
     ...
     */
    public static boolean belongsInUsefulVariableSet(String variable, Grammar grammar,
            Set<String> set) {
     ...
     *         <CODE>set</CODE>.
     */
    public static boolean areMoreVariablesThatBelongInUsefulVariableSet(Grammar grammar,
            Set<String> set) {
     ...
     */
    public static Set<Production> getCompleteProductionWithUsefulVariableSet(Grammar grammar,
            Set<String> usefulVariableSet) {
     ...
     */
    public static boolean belongsInProductionWithUsefulVariableSet(Production production,
            Set<String> usefulVariableSet) {
     ...
     */
    public static void addToProductionWithUsefulVariableSet(Production production,
            Set<Production> set) {
        set.add(production);
    }
     ...
     *            the grammar.
     */
    public static void initializeVariableDependencyGraph(VariableDependencyGraph graph,
            Grammar grammar) {
        String[] variables = getCompleteUsefulVariableSet(grammar)
        for (int k = 0; k < variables.length; k++) {
            double theta = 2.0 * Math.PI * k / variables.length;
