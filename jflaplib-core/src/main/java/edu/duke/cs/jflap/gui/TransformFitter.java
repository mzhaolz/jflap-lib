...
public abstract class TransformFitter {
	 ...
	 * <I>rectDraw</I> will fit entirely within the area defined by rectangle
	 * <I>rectSpace</I>.
	 *
	 * @param rectDraw
	 ...
	 *            the rec
	 */
	public static AffineTransform fit(final Rectangle rectDraw, final Rectangle rectSpace) {
