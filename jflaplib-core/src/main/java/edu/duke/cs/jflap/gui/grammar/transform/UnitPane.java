...
/**
  ...
  private JPanel initRightPanel() {
    ...
    JSplitPane rightSplit =
        SplitPaneFactory.createSplit(environment, false, 0.5, vdgEditor, grammarEditor);
  ...
  private void initEditingGrammarTable() {
    editingGrammarModel.addTableModelListener(
  ...
  private void deleteActivated() {
    if (controller.step != UnitController.PRODUCTION_MODIFY) return;
    cancelEditing();
