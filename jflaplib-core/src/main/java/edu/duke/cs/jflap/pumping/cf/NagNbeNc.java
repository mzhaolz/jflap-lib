...
public class NagNbeNc extends ContextFreePumpingLemma {
   ...
   *
   */
  private static final long serialVersionUID = -5991854603963403362L;
  ...
  public void setDescription() {
    ...
    explanation =
        "For any <i>m</i> value, a possible value for <i>w</i> is \"a<sup><i>m</i>+1</sup>"
  ...
  public void chooseDecomposition() {
    ...
    if (a > b + 1) setDecomposition(new int[] {0, 1, 0, 0});
    else super.chooseDecomposition();
  }

  public void chooseI() {
    if (getV().indexOf("a") == -1 && getY().indexOf("a") == -1) i = 2;
    else i = 0;
  }
