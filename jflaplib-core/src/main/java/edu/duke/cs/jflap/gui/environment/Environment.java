 ...
 * the object that this environment contains. For example, each
 * <CODE>Environment</CODE> instance has, at minimum some sort of component
 * whereby this structure can be edited. The <CODE>Environment</CODE> instance
 * keeps track of and displays these various components.
 *
