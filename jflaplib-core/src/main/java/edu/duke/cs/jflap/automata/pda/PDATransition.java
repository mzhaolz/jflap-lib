...
public class PDATransition extends Transition {
     ...
     */
    public PDATransition(State from,
            State to,
            String inputToRead,
            String stringToPop,
            String stringToPush) {
    ...
    protected void setStringToPop(String stringToPop) {
         ...
         */
        PushdownAutomaton myPDA = (PushdownAutomaton) getAutomaton();
    ...
    @Override
    public int hashCode() {
        return super.hashCode() ^ myInputToRead.hashCode() ^ myStringToPop.hashCode()
