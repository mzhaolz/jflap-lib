...
public class PDATransition extends Transition {
  ...
  public PDATransition(
      State from, State to, String inputToRead, String stringToPop, String stringToPush) {
    super(from, to);
  ...
  public String getDescription() {
    ...
    if (toPop.length() == 0) toPop = Universe.curProfile.getEmptyString();
    String toPush = getStringToPush();
    if (toPush.length() == 0) toPush = Universe.curProfile.getEmptyString();
