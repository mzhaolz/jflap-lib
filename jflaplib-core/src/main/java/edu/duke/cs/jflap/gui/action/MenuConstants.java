...
/**
 * The <TT>MenuConstants</TT> class is a simple class for retrieving information
 * universally important to menu items.
 *
...
public class MenuConstants {
    ...
    private static void initMainMenuMask() {
        ...
        if ((s.lastIndexOf("Windows") != -1) || (s.lastIndexOf("windows") != -1))
            MAIN_MENU_MASK = InputEvent.CTRL_MASK;
        else MAIN_MENU_MASK = InputEvent.META_MASK;
    }
