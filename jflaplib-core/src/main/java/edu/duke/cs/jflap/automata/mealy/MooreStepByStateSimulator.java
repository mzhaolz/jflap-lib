 ...
 * on the object. The <code>MooreStepByStateSimulator</code> is different from
 * the <code>MealyStepByStateSimulator</code> in that it produces output in
 * states, not transitions, and output is produced in the first state.
 *
 * <p>
...
public class MooreStepByStateSimulator extends MealyStepByStateSimulator {
	 ...
	 */
	public MooreStepByStateSimulator(final Automaton automaton) {
		super(automaton);
	}
