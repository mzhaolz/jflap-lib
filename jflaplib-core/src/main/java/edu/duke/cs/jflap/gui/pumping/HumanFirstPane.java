...
public abstract class HumanFirstPane extends PumpingLemmaInputPane {
        ...
        myDecompButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                if (myLemma.isInLang(myLemma.createPumpedString()))
                    myLemma.addAttempt(myLemma.getDecompositionAsString() + "; I = "
                            + myLemma.getI() + "; <i>Won</i>");
                else myLemma.addAttempt(myLemma.getDecompositionAsString() + "; I = "
                        + myLemma.getI() + "; <i>Failed</i>");
                updateTopPane(false);
            ...
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    String error = "Please enter a positive integer in range ["
                            + myLemma.getRange()[0] + ", " + myLemma.getRange()[1]
                            + "] for best results.";
    ...
    public void displayEnd() {
        ...
        else myLastWord.setText(createXYZ() + " = " + PumpingLemmaInputPane.toHTMLString(s) + " = "
