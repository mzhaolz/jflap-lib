...
public abstract class HumanFirstPane extends PumpingLemmaInputPane {
  ...
  private static String DESCRIBE_I =
      "I have selected i to give a contradition. It is displayed in Box 4.";
  /**
...
protected JPanel initDecompPanel() {
    ...
    myDecompButton.addActionListener(
        ...
        public void actionPerformed(ActionEvent ev) {
            ...
            if (myLemma.isInLang(myLemma.createPumpedString()))
              myLemma.addAttempt(
                  myLemma.getDecompositionAsString() + "; I = " + myLemma.getI() + "; <i>Won</i>");
            else
              myLemma.addAttempt(
  ...
  public void updateTable() {
    ...
    for (int i = 0; i < s.length(); i++) myXYZDisplay.setValueAt(s.substring(i, i + 1), 0, i);
        ...
        .addActionListener(
            ...
            public void actionPerformed(ActionEvent ev) {
                try {
                   ...
                   */
                  if (myCases != null) myCases.setListButtonEnabled(true);
