...
public class LSystemInputPane extends JPanel {
  ...
  private void initializeView() {
    ...
    JSplitPane split = new JSplitPane(JSplitPane.VERTICAL_SPLIT, productionInputPane, scroller);
    ...
    String[] words = (String[]) Renderer.ASSIGN_WORDS.toArray(new String[0]);
  ...
  public LSystem getLSystem() {
    ...
    if (parameterTable.getCellEditor() != null) parameterTable.getCellEditor().stopCellEditing();
    ...
    try {
      ...
      JOptionPane.showMessageDialog(
          this, e.getMessage(), "L-System Error", JOptionPane.ERROR_MESSAGE);
    }
    return cachedSystem;
  }
