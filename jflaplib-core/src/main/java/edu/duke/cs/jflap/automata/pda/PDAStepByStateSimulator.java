...
public class PDAStepByStateSimulator extends AutomatonSimulator {
    ...
    public PDAStepByStateSimulator(Automaton automaton) {
        ...
        Object selectedValue = JOptionPane.showInputDialog(null, "Accept by", "Input",
    ...
    public List<Configuration> getInitialConfigurations(String input) {
        ...
        stack.push("Z");
        configs.add(new PDAConfiguration(myAutomaton.getInitialState(), null, input, input, stack,
                myAcceptance));
        return configs;
    }
    ...
    public List<? extends Configuration> stepConfiguration(Configuration config) {
        ...
        for (int k = 0; k < transitions.size(); k++) {
            ...
            if (unprocessedInput.startsWith(inputToRead) && stringToPop.equals(stackContents)) {
                ...
                PDAConfiguration configurationToAdd = new PDAConfiguration(toState, configuration,
                        totalInput, input, stack, myAcceptance);
