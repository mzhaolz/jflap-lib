...
/**
 * A <code>MovingText</code> object is a <code>Text</code> object that allows
 * movement of the text. It contains extra fields that record the start and end
 * position, and the size of each step.
 *
 * @author Jinghui Lim
...
public class MovingText extends Text {
	 ...
	 */
	private final Point2D.Double myStart;
	/**
	 * The final position.
	 */
	private final Point2D.Double myFinish;
	/**
	 * The size of each step.
	 */
	private final Point2D.Double myStep;
	 ...
	 *
	 * @param t
	 *            the <code>Text</code> we wish to construct a moving copy of
	 * @param finish
	 *            the final position
	 */
	public MovingText(final Text t, final Point2D finish) {
		super(t);
	 ...
	 * <code>MovingText</code> object should be treated as a <code>Text</code>
	 * object.
	 *
	 * @return a <code>Text</code> object whose position is the final position
	 *         of this <code>MovingText</code> object
	 */
