...
public class State implements Serializable {
	 ...
	 */
	public State(final int id, final Point point, final Automaton automaton) {
		this.point = point;
		this.id = id;
	 ...
	 *
	 * @return the descriptive label of the state, or <CODE>null</CODE> if this
	 *         state has no label
	 */
	...
	// * @return <CODE>true</CODE> if this state the final state in the building
	// block
	// */
	...
	// * @param type <CODE>true</CODE> if this state is the final state in a
	// block.
	// */
	...
	public void setAutomaton(final Automaton auto) {
		automaton = auto;
	}
	...
	public void setLabel(final String label) {
		...
		if (label == null) {
			...
			final StringTokenizer st = new StringTokenizer(label, "\n");
	...
	/**
	 * Sets the name for this state. A parameter of <CODE>null</CODE> will reset
	 * this to the default.
	 *
	 * @param name
	...
	// /** If the state has a parent block, this is it. It is null if there is
	// no parent block. */
	...
	public int specialHash() {
		...
		return point.hashCode() + (myNote == null ? -1 : myNote.specialHash())
	...
	public String toString() {
		return "q_" + Integer.toString(getID()) + " at (" + Integer.toString(getPoint().x) + ","
