...
public class NoInteractionSimulateAction extends SimulateAction {
    ...
    protected boolean reportConfiguration(Configuration configuration, Component component) {
        JComponent past = edu.duke.cs.jflap.gui.sim.TraceWindow.getPastPane(configuration);
        past.setPreferredSize(new java.awt.Dimension(300, 400));
        String[] options = { "Keep looking", "I'm done" };
        int result = JOptionPane.showOptionDialog(component, past, "Accepting configuration found!",
    ...
    public void handleInteraction(Automaton automaton, AutomatonSimulator simulator,
        ...
        JOptionPane.showMessageDialog(frame,
                numberAccepted + " configuration" + (numberAccepted == 1 ? "" : "s")
