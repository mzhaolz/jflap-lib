...
public class MenuBarCreator {
                ...
                if (new File("svg.jar").exists()
                    ...
                    try {
                        RestrictedAction ra = (RestrictedAction) Class
                                ...
                                .getConstructor(new Class[] { Environment.class })
    ...
    private static JMenu getViewMenu(EnvironmentFrame frame) {
        ...
        if (AutomatonAction.isApplicable(object)) {
            ...
            subMenu.add(new LayoutAlgorithmAction("Diagonal From Upper-Left To Lower-Right",
                    automaton, environment, VertexMover.POSITIVE_SLOPE_DIAGONAL));
            subMenu.add(new LayoutAlgorithmAction("Diagonal From Lower-Left To Upper-Right",
                    automaton, environment, VertexMover.NEGATIVE_SLOPE_DIAGONAL));
            viewMenu.add(subMenu);
            viewMenu.add(new LayoutAlgorithmAction("Rotate The Graph", automaton, environment,
                    VertexMover.ROTATE));
            viewMenu.add(new LayoutAlgorithmAction("Fill Screen With Graph", automaton, environment,
                    VertexMover.FILL));
            menu.add(viewMenu);
            ...
            viewMenu.add(new LayoutAlgorithmAction("Circle", automaton, environment,
                    LayoutAlgorithmFactory.CIRCLE));
            viewMenu.add(new LayoutAlgorithmAction("GEM", automaton, environment,
                    LayoutAlgorithmFactory.GEM));
            viewMenu.add(new LayoutAlgorithmAction("Random", automaton, environment,
                    LayoutAlgorithmFactory.RANDOM));
            viewMenu.add(new LayoutAlgorithmAction("Spiral", automaton, environment,
                    LayoutAlgorithmFactory.SPIRAL));
            subMenu = new JMenu("Tree");
            subMenu.add(new LayoutAlgorithmAction("Degree", automaton, environment,
                    LayoutAlgorithmFactory.TREE_DEGREE));
            subMenu.add(new LayoutAlgorithmAction("Hierarchy", automaton, environment,
                    LayoutAlgorithmFactory.TREE_HIERARCHY));
            viewMenu.add(subMenu);
            viewMenu.add(new LayoutAlgorithmAction("Two Circle", automaton, environment,
                    LayoutAlgorithmFactory.TWO_CIRCLE));
            menu.add(viewMenu);
    ...
    private static JMenu getTestMenu(EnvironmentFrame frame) {
         ...
         */
        if (AutomatonAction.isApplicable(object)) {
            addItem(menu, new LambdaHighlightAction((edu.duke.cs.jflap.automata.Automaton) object,
                    environment));
        }
