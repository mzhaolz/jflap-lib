...
public class MenuBarCreator {
      ...
      if (environment instanceof AutomatonEnvironment) { //this is strictly for non-Grammar
        ...
        if (new File("svg.jar").exists()
          ...
          try {
            RestrictedAction ra =
                (RestrictedAction)
                    Class.forName("gui.action.ExportAction")
  ...
  private static JMenu getViewMenu(EnvironmentFrame frame) {
    ...
    if (AutomatonAction.isApplicable(object)) {
      ...
      LayoutStorageAction store =
          new LayoutStorageAction(
              "Save Current Graph Layout", "Restore Saved Graph Layout", automaton);
      menu.add(store);
      ...
      subMenu.add(
          new LayoutAlgorithmAction(
              "Vertical Line Through Center", automaton, environment, VertexMover.VERTICAL_CENTER));
      subMenu.add(
          new LayoutAlgorithmAction(
      ...
      viewMenu.add(
          new LayoutAlgorithmAction(
              "Rotate The Graph", automaton, environment, VertexMover.ROTATE));
      viewMenu.add(
          new LayoutAlgorithmAction(
              "Fill Screen With Graph", automaton, environment, VertexMover.FILL));
      menu.add(viewMenu);

      menu.add(
          new LayoutAlgorithmAction(
              "Apply A Random Layout Algorithm",
              automaton,
              environment,
      ...
      viewMenu.add(
          new LayoutAlgorithmAction(
              "Circle", automaton, environment, LayoutAlgorithmFactory.CIRCLE));
      viewMenu.add(
          new LayoutAlgorithmAction("GEM", automaton, environment, LayoutAlgorithmFactory.GEM));
      viewMenu.add(
          new LayoutAlgorithmAction(
              "Random", automaton, environment, LayoutAlgorithmFactory.RANDOM));
      viewMenu.add(
          new LayoutAlgorithmAction(
              "Spiral", automaton, environment, LayoutAlgorithmFactory.SPIRAL));
      subMenu = new JMenu("Tree");
      subMenu.add(
          new LayoutAlgorithmAction(
              "Degree", automaton, environment, LayoutAlgorithmFactory.TREE_DEGREE));
      subMenu.add(
          new LayoutAlgorithmAction(
              "Hierarchy", automaton, environment, LayoutAlgorithmFactory.TREE_HIERARCHY));
      viewMenu.add(subMenu);
      viewMenu.add(
          new LayoutAlgorithmAction(
              "Two Circle", automaton, environment, LayoutAlgorithmFactory.TWO_CIRCLE));
      menu.add(viewMenu);
  ...
  private static JMenu getTestMenu(EnvironmentFrame frame) {
    ...
    if (NondeterminismAction.isApplicable(object))
      addItem(
          menu,
          new NondeterminismAction((edu.duke.cs.jflap.automata.Automaton) object, environment));
    /*
