 ...
 * of an action. In short, those components with tags marked as
 * <CODE>EditorTag</CODE> must be deactivated. The intention is that an
 * <CODE>Environment</CODE> will detect the presence of critical tagged objects,
 * and will not allow other <CODE>EditorTag</CODE> objects to be selectable.
 *
