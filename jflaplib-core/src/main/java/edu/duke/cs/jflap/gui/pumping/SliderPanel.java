...
/**
 * A <code>SliderPanel</code> object allows the user to choose the decomposition
 * of <i>w</i> with sliders, and will display the the string segement as well as
 * its length in text areas.
 *
 * @author Jinghui Lim
...
public class SliderPanel extends JPanel {
	...
	/**
	 * The parent <code>PumpingLemmaInputPane</code> of this
	 * <code>SliderPanel</code>.
	 */
	private final HumanFirstPane myPane;
	/**
	 * The text area that displays the string segment.
	 */
	private final JTextArea myDisplay;
	/**
	 * The text area that displays the length of the string segment.
	 */
	private final JTextArea myLengthDisplay;
	/**
	 ...
	 * <code>SliderPanel</code> is concerned with is set with <code>myMin</code>
	 * and the value of <code>mySlider</code>.
	 */
	private String myText;

	/**
	 * Constructs the slider panel from the "name" of the string segment given
	 * with the <code>PumpingInputPane</code> as its "parent" pane.
	 *
	 * @param s
	 *            the name of the string segment
	 * @param p
	 *            the parten <code>PumpingInputPane</code>
	 */
	public SliderPanel(final String s, final HumanFirstPane p) {
	...
	/**
	 * Updates the various text areas depending on the value of the slider.
	 *
	 */
	public void refresh() {
		try {
			 ...
			 * adjusting the max of the slider. Thus, the exception is ignored.
			 */
		}
		// getRootPane().repaint();
	}
	...
	/**
	 * Resets the <code>SliderPanel</code>. Clears the string and sets the
	 * slider to zero.
	 *
	 */
	public void reset() {
	 ...
	 *
	 * @param min
	 *            the index of the first letter of the segment
	...
	/**
	 * Sets the minimum and maximum of the segment (which is a substring of
	 * <i>w</i>.
	 *
	 * @param min
	 *            the index of the first letter of the segment
	 * @param max
	 *            the index of the last letter of the segment
	 * @see #setText(String)
	 */
	 ...
	 * {@link #setMin(int)} and {@link #setRange(int, int)} in that it sets the
	 * maximum of the slider, not the string segement. Usually, <code>i</code> =
	 * |<i>w</i>|.
	 *
	 * @param i
	...
	/**
	 * Sets the string of this <code>SliderPanel</code>. The paramter
	 * <code>s</code> should be <i>w</i>. The string segment then depends on
	 * values set in {@link #setRange(int, int)} or {@link #setMin(int)}.
	 *
	 * @param s
	 *            the string to set
	 */
