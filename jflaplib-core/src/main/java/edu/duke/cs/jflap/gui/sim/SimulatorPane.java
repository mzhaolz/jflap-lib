...
public class SimulatorPane extends JPanel {
    ...
    private void initView(List<Configuration> configs, final Environment env, boolean blockStep) {
        ...
        JScrollPane scroller = new JScrollPane(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
        ...
        JSplitPane split = SplitPaneFactory.createSplit(env, false, .6, display, lower);
