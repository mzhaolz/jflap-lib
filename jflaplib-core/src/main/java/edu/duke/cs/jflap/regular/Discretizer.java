...
public class Discretizer {
	 ...
	 */
	public static List<String> cat(final String expression) {
		final ArrayList<String> se = new ArrayList<>(); // Subexpressions.
		int start = 0;
		int level = 0;
	 ...
	 *         string
	 */
	public static String delambda(final String string) {
		return string.equals(Universe.curProfile.getEmptyString()) ? "" : string;
	}

	public static void main(final String[] args) {
		for (final String arg : args) {
			System.out.println(Arrays.asList(or(arg)));
			System.out.println(Arrays.asList(cat(arg)));
		}
	}
	 ...
	 * @return an array of the subexpressions
	 */
	public static List<String> or(final String expression) {
		final ArrayList<String> se = new ArrayList<>(); // Subexpressions.
		int start = 0;
		int level = 0;
		for (int i = 0; i < expression.length(); i++) {
