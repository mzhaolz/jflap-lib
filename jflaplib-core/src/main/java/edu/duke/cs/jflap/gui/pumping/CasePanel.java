...
/**
    ...
    myDone.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            else myMessage.setText("All cases done.");
          }
        });
  ...
  protected void replaceCase(int index) {
    ...
    else myMessage.setText("Wrong case selected.");
  }
  ...
  public void setAddReplaceButtonsEnabled(boolean b) {
    ...
    if (myShowCase.isEnabled()) myReplace.setEnabled(b);
  }
