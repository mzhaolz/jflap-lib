...
public class DeexpressionifyTransitionTool extends Tool {
	 ...
	 */
	public DeexpressionifyTransitionTool(final AutomatonPane view, final AutomatonDrawer drawer,
	...
	protected Icon getIcon() {
		final java.net.URL url = getClass().getResource("/ICON/de-expressionify.gif");
