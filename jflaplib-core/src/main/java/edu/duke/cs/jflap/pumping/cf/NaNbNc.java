...
/**
 * The context-free pumping lemma for <i>L</i> = {<i>w</i> &#8712; {<i>a</i>,
 * <i>b</i>, <i>c</i>}* : <i>n<sub>a</sub></i> (<i>w</i>) &#60;
...
public class NaNbNc extends ContextFreePumpingLemma {
	...
	public void chooseDecomposition() {
		...
		if (c > b + 1) {
			setDecomposition(Lists.newArrayList(w.indexOf('c'), 1, 0, 0));
		} else if (b > a + 1) {
			setDecomposition(Lists.newArrayList(w.indexOf('b'), 1, 0, 0));
		} else {
	...
	@Override
	public void chooseI() {
		final int c = LemmaMath.countInstances(getV(), 'c') + LemmaMath.countInstances(getY(), 'c');
	...
	public String getHTMLTitle() {
		return "<i>w</i> " + ELEMENT_OF + " {<i>a</i>, <i>b</i>, <i>c</i>}* :" + " <i>n<sub>a</sub></i> (<i>w</i>) "
				+ LESS_THAN + " <i>n<sub>b</sub></i> (<i>w</i>) " + LESS_THAN + " <i>n<sub>c</sub></i> (<i>w</i>)";
	}
