...
public class CommandLine {
  ...
  public static void main(String[] args) throws IllegalAccessException, InstantiationException {
    ...
    Cli.include("run", RunInputCommand.class)
  ...
  private static File checked(File file) {
    ...
    if (!file.isFile())
      throw new RuntimeException("File: " + file.getAbsolutePath() + " is not a valid file");
    return file;
  }

  @Parameters(
    separators = "=",
    commandDescription = "Convert a Finite State Automaton to a Regular Expression"
  )
  ...
  @Parameters(
    separators = "=",
    commandDescription = "Runs the JFLAP automaton file on the input string"
  )
  public static class RunInputCommand implements Runnable {
    ...
    public void run() {
      if (params.size() != 2)
        throw new RuntimeException("Incorrect arguments. Please provide <file> <input>");
      ...
      if (sim == null)
        throw new RuntimeException(
            "Cannot load an automaton simulator for " + automaton.getClass());
