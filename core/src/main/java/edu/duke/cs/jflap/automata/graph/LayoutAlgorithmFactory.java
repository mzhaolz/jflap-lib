...
/**
 * This class allows the user to fetch a new <code>LayoutAlgorithm</code>,
 * either a random one or a specific one. It also allows the user to fetch a
 * particular <code>AutomatonGraph</code> that corresponds to a given
 * <code>LayoutAlgorithm</code>.
 *
 * @author Chris Morgan
 */
public class LayoutAlgorithmFactory {
	/**
	 * Value that represents the number of <code>LayoutAlgorithms</code> of
	 * which this factory currently has knowledge. Used to generate a random
	 * <code>LayoutAlgorithm</code>, so if changed, one should make sure all
	 * integers from 0 to <i>NUM_ALGORITHMS</i>-1 are numerical identifiers for
	 * <code>LayoutAlgorithms</code>.
	 */
	private static final int NUM_ALGORITHMS = 7;
	/**
	 * Numerical identifier for choosing a random </code>LayoutAlgorithm</code>
	 * instance.
	 */
	...
	/**
	 * Numerical identifier for a <code>TreeLayoutAlgorithm</code> instance with
	 * a hierarchical tree.
	 */
	...
	/**
	 * Numerical identifier for a <code>TwoCircleLayoutAlgorithm</code>
	 * instance.
	 */
	public static final int TWO_CIRCLE = 6;

	/**
	 * Returns the correct <code>AutomatonGraph</code> that corresponds with
	 * this layout algorithm.
	 *
	 * @param algorithm
	 *            a numerical identifier for the specific layout algorithm which
	 *            will use the graph.
	 * @param automaton
	 *            the automaton that will be used to generate the graph.
	 * @return the correct <code>AutomatonGraph</code>.
	 */
	public static AutomatonGraph getAutomatonGraph(final int algorithm, final Automaton automaton) {
	...
	/**
	 * Returns a <code>LayoutAlgorithm</code> corresponding to the numerical
	 * identifier given.
	 *
	 * @param algorithm
	 *            a numerical identifier for the specific layout algorithm that
	 *            should be generated.
	 * @return A layout algorithm corresponding to the <code>algorithm</code>
	 *         value.
	 */
	public static <V> LayoutAlgorithm<V> getLayoutAlgorithm(final int algorithm) {
		switch (algorithm) {
		case RANDOM_CHOICE:
	 ...
	 *         value.
	 */
	public static <V> LayoutAlgorithm<V> getLayoutAlgorithm(final int algorithm, final Dimension pSize,
			final Dimension vDim, final double vBuffer) {
		switch (algorithm) {
		case RANDOM_CHOICE:
	...
	/**
	 * Returns a random <code>LayoutAlgorithm</code> among those defined. Should
	 * not be mistaken for an algorithm always creating a
	 * <code>RandomLayoutAlgorithm</code> instance.
	 *
	 ...
	 * @return A random <code>LayoutAlgorithm</code> among those defined.
	 */
	public static <V> LayoutAlgorithm<V> getRandomLayoutAlgorithm(final Dimension pSize, final Dimension vDim,
			final double vBuffer) {
		final Random random = new Random();
