 ...
 * MealyTransition</code> in which the output of each transition is constrained
 * to be a the value of output of its "to" state.
 *
 * @see MooreMachine
 * @author Jinghui Lim
 *
...
public class MooreTransition extends MealyTransition {
	 ...
	 */
	public MooreTransition(final State from, final State to, final String label) {
	 ...
	 */
	public MooreTransition(final State from, final State to, final String label, final String output) {
