...
public abstract class TransitionCreator {
	 ...
	 */
	public static TransitionCreator creatorForAutomaton(final Automaton automaton, final AutomatonPane parent) {
	...
	public TransitionCreator(final AutomatonPane parent) {
		this.parent = parent;
	}
	 ...
	 */
	public void editTransition(final Transition transition, final Point point) {
	 ...
	 */
	public void reportException(final IllegalArgumentException e) {
		JOptionPane.showMessageDialog(getParent(), "Bad format!\n" + e.getMessage(), "Bad Format",
