...
public class TransducerFactory {
	 ...
	 */
	private static void add(String type, final Class<?> structureClass, final Object transducer) {
		if (type == null) {
	...
	public static Transducer getTransducer(final Document document) {
		...
		// Check for the type.
		final Object o = typeToTransducer.get(type);
		if (o == null) {
	 ...
	 */
	public static Transducer getTransducer(final Serializable structure) {
		Class<?> c = structure.getClass();
		// Cycle through the superclasses.
		while (c != null) {
			final Object o = classToTransducer.get(c);
			if (o != null) {
				return instantiate(o);
			}
			c = c.getSuperclass();
	 ...
	 * <TT>java.lang.Class</TT>, a new instance is returned. If the passed in is
	 * a {@link edu.duke.cs.jflap.file.Transducer}, the argument is cast and
	 * returned.
	 *
	 * @param object
	 ...
	 */
	private static Transducer instantiate(final Object object) {
