...
public class GrammarInputPane extends JPanel {
	...
	private final GrammarTableModel model;
	...
	/**
	 * Instantiates a <CODE>GrammarInputPane</CODE> that holds and displays the
	 * indicated grammar.
	 *
	 * @param grammar
	 *            the grammar to display
	 */
	public GrammarInputPane(final Grammar grammar) {
	 ...
	 * <CODE>GrammarInputPane</CODE>. This method returns a grammar of the type
	 * <CODE>ContextFreeGrammar</CODE>.
	 *
	...
	/**
	 * Returns the grammar that has been defined through this
	 * <CODE>GrammarInputPane</CODE>, where the grammar is an instance of the
	 * class passed into this function.
	 *
	 * @param grammarClass
	...
	private void initLargerView() {
		...
		final TableColumn lhs = table.getColumnModel().getColumn(0);
		table.getColumnModel().getColumn(1);
		final TableColumn rhs = table.getColumnModel().getColumn(2);
	...
	private void initView() {
		...
		final TableColumn lhs = table.getColumnModel().getColumn(0);
		final TableColumn arrows = table.getColumnModel().getColumn(1);
		final TableColumn rhs = table.getColumnModel().getColumn(2);
		lhs.setHeaderValue("LHS");
		table.getTableHeader().resizeAndRepaint();
		rhs.setHeaderValue("RHS");
