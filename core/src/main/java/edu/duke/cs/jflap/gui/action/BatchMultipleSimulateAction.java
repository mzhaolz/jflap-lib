...
public class BatchMultipleSimulateAction extends MultipleSimulateAction {
	 ...
	 */
	public BatchMultipleSimulateAction(final Automaton automaton, final Environment environment) {
	...
	public BatchMultipleSimulateAction(final Grammar gram, final Environment environment) {
